          ...
          <table className="w-full text-left text-sm text-slate-600">
            <thead className="bg-slate-50 text-slate-900 font-semibold border-b border-slate-200">
              <tr>
                ...
                <th className="px-6 py-4 text-right">Net Qty Bought</th>
                <th className="px-6 py-4 text-right">Approx. Buy Value (Rs cr)</th>
              </tr>
            </thead>
                  ...
                  <tr key={idx} className="hover:bg-slate-50/50">
                    <td className="px-6 py-4 font-medium text-slate-900">
                      <span className="inline-flex items-center gap-2">
                        <span className="p-1.5 bg-pink-50 text-pink-600 rounded-md">
                    ...
                    <td className="px-6 py-4 text-right">{row.net_qty_bought?.toLocaleString() ?? '—'}</td>
                    <td className="px-6 py-4 text-right">{row.approx_buy_value_cr != null ? row.approx_buy_value_cr.toLocaleString() : '—'}</td>
                  </tr>
                ))
              ) : (
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-slate-500">No favorites found</td>
                </tr>
              )}
            </tbody>
          </table>
